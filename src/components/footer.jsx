...
export const Footer = () => {
    return(
                ...
                <ul className='font-semibold text-white'>
                    ...
                    <li className='hover:scale-110 hover:text-cyan-500'>
                        <Link 
                            ...
                            target='_blank'
                            >Estado del sistema TMDB
                        </Link>
                    </li>
                </ul>
            </div>
            <div className='text-center md:text-left mt-6 md:mt-0' id='container-contact-me'>
        ...
        <span className='flex w-full text-white mb-10 place-content-center font-bold text-lg'> Desarrollado por Franco Erben </span>
        </div>
