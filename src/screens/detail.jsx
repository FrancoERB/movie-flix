  ...
  return (
    <>
      {movie ? (
        ...
        >
          <div className="flex sm:flex-col md:flex-row lg:flex-row h-screen sm:h-[110vh] backdrop-brightness-50 backdrop-blur-md sm:pt-3 md:pt-10 lg:pt-10">
            ...
            <div className="flex flex-col md:w-screen lg:w-screen sm:ml-0 md:ml-4 lg:ml-4 sm:w-screen sm:h-[150vh] sm:mt-[10%] md:h-[450px] lg:h-[450px] md:mt-12 md:mx-11 rounded-md">
              {!showTrailer ? (
                <>
                  ...
                  <h3 className="text-2xl sm:text-xl md:text-base font-bold ml-2 sm:mt-1 md:mt-4 text-white opacity-70">
                    {movie.tagline}
                  </h3>
                  <h3 className="flex ml-2 sm:text-xl md:text-2xl mt-5 text-white font-bold">
                    Vista general
                  </h3>
                  <p className="w-full sm:h-24 md:text-sm md:h-fit overflow-scroll md:overflow-visible lg:overflow-visible text-white text-base ml-2">
                    {movie.overview}
                  </p>
