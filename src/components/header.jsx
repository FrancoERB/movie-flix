    ...
    return(
        <header className={`flex items-center w-full fixed top-0 left-0 z-10 transition-opacity duration-700 ${
            visible ? 'bg-black' : 'opacity-0'}`}>
             <div className='md:flex items-center justify-between py-2 sm:px-10 md:px-10 px-7 w-full' id='container-main'>
                  ...
                  <div onClick={() => setMenuOpen(!menuOpen)} className='text-3xl absolute right-8 top-4 cursor-pointer text-white md:hidden' id='container-burguer-menu'>
                  ...
                  {pathName !== '/' &&  pathName !== '/Sign-up' &&
                     ...
                     <div className={`flex w-56 ${menuOpen && 'mt-5 '} items-center mr-20`} id='input-search-container'>
                        <input 
                          name='inputSearch'
                          className={`text-white h-10 ${menuOpen && 'w-[400px]' } bg-zinc-800 rounded-xl px-5 text-center`} 
