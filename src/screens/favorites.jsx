    ...
    return(
        <div className='flex flex-col w-full'>
            <div className='w-screen pt-14 top-0'>
             <h1 className="text-xl font-bold ml-2 w-fit px-3 py-1 mt-2 rounded-2xl  bg-gradient-to-r from-[#4b79a1] to-[#283e51] text-white">
            ...
            <div className='grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 sm:overflow-auto md:overflow-y-visible sm:max-h-[100%] md:max-h-[100%] lg:max-w-[100%] sm:gap-1 md:gap-4 lg:gap-4 w-full sm:h-fit mt-1 place-items-start dark:bg-slate-950 animate__animated animate__fadeIn animate__fast'>
            {movies.map((movie)=>(
                    <CardView
                    key={movie.id}
                    title={movie.title}
